    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <form action="/gaji/{{ $gaji->id }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="mb-3 form-group">
                        <label class="fw-semibold" for="amil_id">Nama Karyawan</label>
                        <input type="text" class="form-control fw-semibold text-info form-control-solid"
                            value="{{ old('kode_amil', $gaji->amil->kode_amil . ' - ' . $gaji->nama_amil) }}" readonly
                            id="amil_id" name="kode_amil_tampil">
                        <input type="hidden" name="kode_amil"
                            value="{{ old('kode_amil', $gaji->kode_amil) }}">
                    </div>

                    <div class="mb-3 form-group">
                        <label class="fw-semibold" for="jumlah_alpa">Jumlah Alpa dalam satu Periode</label>
                        <input type="number" name="jumlah_alpa" value="{{$alpa}}" id="jumlah_alpa" class="form-control"
                            placeholder="Masukkan jumlah ALPA" readonly required>
                    </div>

                    <div class="mb-3 form-group">
                        <label class="fw-semibold" for="transport">Uang Transport</label>
                        <input type="text" class="form-control form-control-solid"
                            value="{{ old('transport', $gaji->transport) }}" id="transport" name="transport"
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <input type="text" class="form-control form-control-solid"
                            value="{{ old('makan', $gaji->makan) }}" id="makan" name="makan"
                            placeholder="Masukkan Nominal" oninput="formatRupiah(this)">
                    </div>
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <input type="text" class="form-control form-control-solid"
                            value="{{ old('lembur', $gaji->lembur) }}" id="lembur" name="lembur"
                            placeholder="Masukkan Nominal" oninput="formatRupiah(this)">
                    </div>
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <input type="text" class="form-control form-control-solid"
                            value="{{ old('bonus', $gaji->bonus) }}" id="bonus" name="bonus"
                            placeholder="Masukkan Nominal" oninput="formatRupiah(this)">
                    </div>
                    ...
                    <div class="mb-3 form-group">
                        ...
                        <input type="text" class="form-control form-control-solid"
                            value="{{ old('tunjangan', $gaji->tunjangan) }}" id="tunjangan" name="tunjangan"
                            placeholder="Masukkan Nominal" oninput="formatRupiah(this)">
                    </div>

                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('coa.store') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid" id="kode_akun" name="kode_akun" type="number"
                                placeholder="Kode Akun" maxlength="3">
                        ...
                        <a class="col-sm-1 btn btn-outline-dark  btn-sm" href="{{ url('/coa') }}" role="button">Batal</a>
                    </form>

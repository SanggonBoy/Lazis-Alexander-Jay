            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-10">
                        ...
                        <hr>
                        <p>{{ $m->jenis_transaksi }} | @if ($m->jenis_transaksi === 'Zakat Fitrah')
                                Anda Telah Membantu {{ number_format($m->jumlah, 0) }} Orang
                            @elseif($m->jenis_transaksi === 'Zakat Mal')
                                Dari Harta Yang Anda Miliki Sebesar Rp. {{ number_format($m->jumlah, 2, ',', '.') }},-
                            @endif
                        </p>
                        @if($m->jenis_transaksi === 'Zakat Mal')
                            <p>Anda Telah Mengamalkan Harta Anda Sebesar Rp. {{ number_format($m->nominal, 2, ',', '.') }},-</p>
                        @endif
                    </div>
                    <div class="col-xl-2">

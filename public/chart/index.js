...
const chartOptions = {
    ...
    series: [{ name: 'Diperoleh', data: [165, 50, 42, 94, 41, 65, 100, 80, 120, 87, 50, 30] }], // Set chart data
    ...
    xaxis: {
        categories: ['Jan', 'Feb', 'March', 'Apr', 'Mei', 'Jun', 'Jul', 'Aug', 'Sept', 'Oct', 'Nov', 'Dec'], // Set x-axis categories
